...
% Sánchez \emph{et al.} (2016) discuss these potential positive effects in comparison to uni-sensory experiences in the treatment of people with severe dementia. Specifically, they discuss the beneficial impact on anxiety symptoms that comes from stimulating different senses which allows for greater sensory environment control. HarmonyScape aims to capitalise on the principles outlined by Sánchez \emph{et al.} (2016), offering multisensory engagement that intertwines visual and auditory stimuli.
...
% Project title __________HarmonyScape: Inclusive 3D Exploration with Music for those living with Dementia_____________________

% Student’s Name   ________Robbie Tippen___________

% Student Number _______2403237t_______

% Student’s Signature ______ ___________

% Supervisor’s Signature ______________________________

% Date ____17/11/2000____
% Ethics checklist for projects

% \begin{figure}
%     \centering
%     \includegraphics[width=0.5\linewidth]{dissertation/images/ethics_checklist.pdf}    
...
\includepdf[pages={1-2}]{dissertation/images/ethics_checklist.pdf}

\section{Pre-Survey Questions}
\includepdf[pages={1-3}]{dissertation/images/Pre-Survey.pdf}

\section{Post-Interview Questions}
\includepdf[pages={1-6}]{dissertation/images/Post-Interview.pdf}

\section{Intellecttual Disabilities-Specific Questions}
\includepdf[pages={1-2}]{dissertation/images/Intellectual Disabilities Specific Questions.pdf}
