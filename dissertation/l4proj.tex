...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{dissertation/images/mem_matching_unflipped.jpg}
    \caption{Memory matching game with no matches made.}
    \label{fig:mem_match_unmatched}
  \end{subfigure}
  \hfill 
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{dissertation/images/mem_matching_midmatch.jpg}
