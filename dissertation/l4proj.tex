...
A crucial part of the NotePlayer script is its communication with the central GameMaster script, which we'll discuss later. When a Note Block is played, the script informs the GameMaster of the note type (A, B, C, D or E). This allows the GameMaster to track the player's progress within the minigame's sequence.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{dissertation/images/Memory_Game_HarmonyScape.png}    
