...
\section{Summary}
This project explored the design and implementation of HarmonyScape, an interactive game environment tailored for individuals living with dementia. Our primary goal was to investigate its potential to promote engagement, offer cognitive stimulation, and provide a positive, multisensory experience.

HarmonyScape displayed moderate success in fostering intrinsic motivation for players. The engaging minigames and gradual revelation of the dynamic soundtrack provided a sense of accomplishment and encouraged exploration. Additionally, the feedback overwhelmingly validated the potential of our dynamic music system, with participants reporting a sense of active involvement in music creation. This aligns with active music therapy approaches, and many expressed that this feature could positively impact mood and agitation for those with dementia, as supported by prior research (Sánchez et al., 2016).
...
The HarmonyScape project demonstrated the potential of interactive game environments to offer moments of engagement, stimulation, and potential therapeutic benefits for individuals living with dementia. Our work, combined with future research guided by the evaluation's insights, can pave the way for innovative and accessible games that meaningfully improve the lives of those with dementia.
