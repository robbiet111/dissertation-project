...
\begin{itemize}
    \item Overview
    \item Pause, Title and End Screens
    \item Interface with instruments
    \item Player Movement
    \item Music dynamically changing with movement (say about jarring noises being disoriienting to users and how we intend to avoid this by implementing gentle audio design, referenving the section thats in background)
    \item Refrence all figures in
    \item Collection of instruments
\end{itemize}
...
\section{Player Movement and Control}
