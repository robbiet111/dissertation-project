...
\begin{itemize}
    ...
    \item Add section sbout dementia and say it is an umbrella term for diseases like alzhiemers and then alzhiemers section
\end{itemize}
...
\section{Theory behind Minigames}
This section describes the different theoretical cocncepts that influenced the minigames in HarmonyScape,  and how they can be used as an interactive means of exercising cognitive skills for those with Alzheimer's and similar neurodegenerative diseases.
...
\subsection{Traditional Sliding Puzzles in the Treatment of Dementia} 
...
However, recent studies suggest that neuroplasticity may not be entirely eliminated in those living with dementia. Evidence indicates some potential for the brain to adapt even in the later stages of the disease. This residual neuroplasticity offers a window of opportunity for interventions designed to stimulate cognitive function.
...
\begin{itemize}
    ...
    \item Link neuroplasticity to Follow The Sound
    \item Link minigames back to theory in background
...
A systematic review conducted by Clare et al. (2003) examined the effectiveness of cognitive
interventions in dementia care. The review found evidence supporting the beneficial effects of
cognitive stimulation interventions on various aspects of cognitive function, including attention
and concentration. Activities such as "Simon" which necessitate both selective attention to focus
on specific elements and sustained attention to accurately remember and reproduce sequences,
have been identified as interventions associated with positive outcomes in cognitive function
(Clare et al., 2003).
...
Fan me off im hot hot hot like stolen chanel lock me up in jail, fingertaps go tap tap tap on my NPCs making disco trap, uncle johnny made my dress that cheap spandex she looks a mess
