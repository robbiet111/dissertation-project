...
\begin{figure}[h]
  ...
  \caption{Screenshot demonstrating the `TriangleGameMaster` script's handling of incorrect card pairings. Mismatched cards are visually returned to their face-down state.} 
