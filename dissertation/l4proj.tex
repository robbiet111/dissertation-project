...
Sasaki et al. (2020) explored the use of sliding puzzle's in the treatment of dementia. 

\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\linewidth]{dissertation/images/sliding_puzzle.jpg}
    \subcaption[a]{gag}
    \subcaption[b]{gagg}
